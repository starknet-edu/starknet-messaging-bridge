...
mod PlayersRegistry {
    ...
    use starknet_messaging_bridge::token::ITDERC20::ITDERC20DispatcherTrait;
    use starknet_messaging_bridge::token::ITDERC20::ITDERC20Dispatcher;
